...
model = SASRec(hidden_size, item_num, state_size, dropout_rate, device, num_heads).to(device)
...
user_interactions.to_csv('../user_interactions_with_text_title_and_predicted_items_by_SASRec.csv', index=False)
with open('../user_interactions_with_text_title_and_predicted_items_by_SASRec.txt', 'w') as f:
