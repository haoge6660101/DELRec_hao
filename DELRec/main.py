...
import torch
from SR_models import SASRec, Caser, GRU
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--TA_prompt_id', default=0, choices=[0, 1, 2], type=int)  # different dataset
    ...
    parser.add_argument('--RPS_prompt_id', default=0, choices=[0, 1, 2], type=int)  # different dataset
